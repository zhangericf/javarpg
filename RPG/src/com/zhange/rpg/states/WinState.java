...
public class WinState extends State {
    ...
    private com.zhange.rpg.graphics.Font font;
    ...
    public WinState(StateManager GSM) {
        super(GSM);
        font = new Font("Font/x05mo.png", 16, 16);
        try {
            img = ImageIO.read(Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("Background/Win.jpg")));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void render(Graphics2D g) {
        ...
        Sprite.drawArray(g, font, "Score : " + (StateManager.Score), new Vector2f(GPhw - (100), recExit+140), 32 , 32, 15   ,0);
    }
}
